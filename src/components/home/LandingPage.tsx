    ...
    <div className="flex flex-col gap-16 md:gap-24 pb-16">
      ...
      <section id="hero" className="relative pt-8 md:pt-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.15]">
                Belajar Seru, <br className="hidden sm:inline" />
              ...
              <p className="text-slate-600 text-base sm:text-lg max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Bimbingan belajar untuk anak usia 3-8 tahun dengan metode
          ...
          {/* 3 FEATURE CARDS (BAR AT HERO BOTTOM) */}
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-md flex items-start gap-4 hover:shadow-lg transition-shadow">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Rasio guru dan murid pada kelas yang ideal untuk perhatian
                  maksimal
                </p>
              </div>
            </div>
      ...
      <section id="program" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center space-y-2 mb-10">
          ...
          <p className="text-xs font-semibold text-emerald-700 uppercase tracking-widest">
            Lihat Program • Informasi Kelas • Smart Kids
          </p>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-xs text-slate-600">
                <li className="flex items-center gap-2">
                  ...
                  <span>Pengenalan Diri</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span>Motorik Dasar</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span>Olah Energi</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
          ...
          <div className="bg-[#f0f7f4] rounded-3xl p-6 border border-emerald-100 flex flex-col justify-between hover:shadow-xl transition-all group">
            <div>
              ...
              <ul className="space-y-2.5 text-xs text-slate-600">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span>Persiapan Sekolah</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span>Smart Kuis</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-[#fff8e7] rounded-3xl p-6 sm:p-8 border border-amber-100 flex flex-col justify-between">
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="relative h-44 sm:h-52 rounded-2xl overflow-hidden shadow-sm bg-amber-200">
                  <Image
          ...
          <div id="testimoni" className="lg:col-span-5 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              {/* Testimonial Card 1 */}
              <div className="bg-[#eaf4eb] rounded-2xl p-5 border border-emerald-100 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-slate-900">Bunda Eti</h4>
                    <p className="text-[11px] text-slate-500">Orang Tua Siswa</p>
                  </div>
                </div>
                <p className="text-xs text-slate-700 italic leading-relaxed">
                  &quot;Saya sangat puas dengan pengajaran yang diberikan oleh
                  smart kids, perkembangan anak sangat cepat.&quot;
                </p>
              </div>

              {/* Testimonial Card 2 */}
              <div className="bg-[#ebf1fa] rounded-2xl p-5 border border-blue-100 space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-blue-200 text-blue-800 flex items-center justify-center font-bold text-sm shrink-0">
                    BL
                  </div>
                  <div>
                    <h4 className="font-bold text-sm text-slate-900">Bunda Lea</h4>
                    <p className="text-[11px] text-slate-500">Orang Tua Siswa</p>
                  </div>
                </div>
                <p className="text-xs text-slate-700 italic leading-relaxed">
                  &quot;Metode pengajaran yang diberikan cukup unik dan efektif
                  untuk anak, anak sudah dapat sosialisasi dengan baik dan
                  mandiri.&quot;
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
            ...
            <div className="space-y-1">
              <h3 className="text-xl sm:text-2xl font-extrabold text-slate-900">
                Yuk, Daftarkan Si Kecil Sekarang!
              </h3>
              <p className="text-xs sm:text-sm text-slate-600 max-w-lg leading-relaxed">
                Bergabunglah bersama Smart Kids DeKeraton dan berikan pengalaman
                belajar terbaik untuk masa depan cerah mereka
              </p>
            </div>
          </div>
